...
const Translations = require('./Translations-27b4fe13.js');
...
const componentFieldMapping = {
    ...
    code: (ff) => (index.h("amplify-code-field", { label: ff.label, placeholder: ff.placeholder, hint: ff.hint, required: ff.required, handleInputChange: ff.handleInputChange, value: ff.value, inputProps: ff.inputProps, disabled: ff.disabled })),
    // TODO: Will create a phone field component once the dial country code component is in
    phone_number: (ff) => (index.h("amplify-phone-field", { label: ff.label, placeholder: ff.placeholder, required: ff.required, handleInputChange: ff.handleInputChange, value: ff.value, inputProps: ff.inputProps, disabled: ff.disabled })),
    default: (ff) => (index.h("amplify-form-field", { label: ff.label, placeholder: ff.placeholder, required: ff.required, handleInputChange: ff.handleInputChange, value: ff.value, inputProps: ff.inputProps, disabled: ff.disabled })),
};
...
const AmplifyCodeField = class {
    constructor(hostRef) {
        ...
        this.label = core.I18n.get(Translations.Translations.CODE_LABEL);
        /** Used for the placeholder label */
        this.placeholder = core.I18n.get(Translations.Translations.CODE_PLACEHOLDER);
        /** The required flag in order to make an input required prior to submitting a form */
        this.required = false;
    }
    render() {
        return (index.h("amplify-form-field", { fieldId: this.fieldId, label: this.label, placeholder: this.placeholder, type: "number", hint: this.hint, required: this.required, handleInputChange: this.handleInputChange, value: this.value, inputProps: this.inputProps, disabled: this.disabled }));
    }
};
...
const AmplifyCountryDialCode = class {
    ...
    render() {
        return index.h("amplify-select", { fieldId: this.fieldId, options: this.options, handleInputChange: this.handleInputChange });
    }
};
...
const AmplifyFormSection = class {
    ...
    render() {
        return (index.h("form", { onSubmit: this.handleSubmit }, index.h("amplify-section", null, index.h("div", null, index.h("slot", { name: "amplify-form-section-header" }, index.h("div", { class: "form-section-header" }, index.h("h3", { "data-test": this.testDataPrefix + '-header-section' }, this.headerText)))), index.h("slot", null), index.h("div", null, index.h("slot", { name: "amplify-form-section-footer" }, index.h("div", { class: "form-section-footer" }, index.h("amplify-button", { type: "submit", "data-test": this.testDataPrefix + '-' + this.testDataPrefix + '-button' }, index.h("amplify-loading-spinner", { style: { display: this.loading ? 'initial' : 'none' } }), index.h("span", { style: { display: this.loading ? 'none' : 'initial' } }, this.submitButtonText)), this.secondaryFooterContent))))));
    }
};
...
const AmplifyPasswordField = class {
    constructor(hostRef) {
        ...
        this.label = core.I18n.get(Translations.Translations.PASSWORD_LABEL);
        /** Used for the placeholder label */
        this.placeholder = core.I18n.get(Translations.Translations.PASSWORD_PLACEHOLDER);
        /** The required flag in order to make an input required prior to submitting a form */
        this.required = false;
    }
    render() {
        return (index.h("amplify-form-field", { type: "password", fieldId: this.fieldId, label: this.label, placeholder: this.placeholder, hint: this.hint, required: this.required, handleInputChange: this.handleInputChange, value: this.value, inputProps: this.inputProps, disabled: this.disabled }));
    }
};
...
const AmplifyPhoneField = class {
    constructor(hostRef) {
        ...
        this.label = core.I18n.get(Translations.Translations.PHONE_LABEL);
        /** Used for the placeholder label */
        this.placeholder = core.I18n.get(Translations.Translations.PHONE_PLACEHOLDER);
        /** The required flag in order to make an input required prior to submitting a form */
        this.required = false;
    }
    render() {
        return (index.h("div", null, index.h("amplify-form-field", { label: this.label, type: "tel", hint: this.hint, required: this.required }, index.h("div", { class: "phone-field", slot: "input" }, index.h("amplify-country-dial-code", { handleInputChange: this.handleInputChange }), index.h("amplify-input", { fieldId: this.fieldId, handleInputChange: this.handleInputChange, placeholder: this.placeholder, name: this.fieldId, value: this.value, inputProps: this.inputProps, disabled: this.disabled })))));
    }
};
...
const AmplifySelect = class {
    ...
    contructSelectOptions(opts) {
        let content = [];
        opts.forEach((opt) => content.push(index.h("option", { value: opt.value }, opt.label)));
        return content;
    }
    render() {
        return (index.h("select", { name: this.fieldId, id: this.fieldId, class: "select", onChange: this.handleInputChange }, this.contructSelectOptions(this.options)));
    }
};
...
const AmplifyUsernameField = class {
    constructor(hostRef) {
        ...
        this.label = core.I18n.get(Translations.Translations.USERNAME_LABEL);
        /** Used for the placeholder label */
        this.placeholder = core.I18n.get(Translations.Translations.USERNAME_PLACEHOLDER);
        /** The required flag in order to make an input required prior to submitting a form */
        this.required = false;
    }
    render() {
        return (index.h("amplify-form-field", { fieldId: this.fieldId, label: this.label, placeholder: this.placeholder, required: this.required, handleInputChange: this.handleInputChange, value: this.value, inputProps: this.inputProps, disabled: this.disabled }));
    }
};
