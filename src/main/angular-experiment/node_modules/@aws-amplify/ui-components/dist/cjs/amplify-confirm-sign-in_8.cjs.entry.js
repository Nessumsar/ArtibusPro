...
const AmplifyVerifyContact = class {
    ...
    renderVerify() {
        ...
        return (index.h("div", null, email && (index.h("amplify-radio-button", { label: core.I18n.get(Translations.Translations.VERIFY_CONTACT_EMAIL_LABEL), key: "email", name: "contact", value: "email", handleInputChange: event => this.handleInputChange(event) })), phone_number && (index.h("amplify-radio-button", { label: core.I18n.get(Translations.Translations.VERIFY_CONTACT_PHONE_LABEL), key: "phone_number", name: "contact", value: "phone_number", handleInputChange: event => this.handleInputChange(event) }))));
    }
    render() {
