...
import { N as NO_AUTH_MODULE_FOUND, S as SETUP_TOTP, g as SUCCESS } from './constants-2b619cf3.js';
import { d as dispatchAuthStateChangeEvent, a as dispatchToastHubEvent } from './helpers-bbc44569.js';
...
const AmplifyTOTPSetup = class {
    ...
    render() {
        return (h("amplify-form-section", { headerText: this.headerText, submitButtonText: I18n.get(Translations.TOTP_SUBMIT_BUTTON_TEXT), handleSubmit: event => this.verifyTotpToken(event), loading: this.loading }, h("div", { class: "totp-setup" }, h("img", { src: this.qrCodeImageSource, alt: I18n.get(Translations.QR_CODE_ALT) }), h("amplify-form-field", { label: I18n.get(Translations.TOTP_LABEL), inputProps: this.inputProps, fieldId: "totpCode", name: "totpCode", handleInputChange: event => this.handleTotpInputChange(event) }))));
    }
};
