import { h, r as registerInstance } from './index-6200044a.js';
import { I18n } from '@aws-amplify/core';
import { T as Translations } from './Translations-6bb65e0f.js';
import { i as CODE_SUFFIX, e as COUNTRY_DIAL_CODE_SUFFIX, E as EMAIL_SUFFIX, j as PASSWORD_SUFFIX, f as PHONE_SUFFIX, k as USERNAME_SUFFIX } from './constants-2b619cf3.js';
var componentFieldMapping = {
    ...
    code: function (ff) { return (h("amplify-code-field", { label: ff.label, placeholder: ff.placeholder, hint: ff.hint, required: ff.required, handleInputChange: ff.handleInputChange, value: ff.value, inputProps: ff.inputProps, disabled: ff.disabled })); },
    // TODO: Will create a phone field component once the dial country code component is in
    phone_number: function (ff) { return (h("amplify-phone-field", { label: ff.label, placeholder: ff.placeholder, required: ff.required, handleInputChange: ff.handleInputChange, value: ff.value, inputProps: ff.inputProps, disabled: ff.disabled })); },
    default: function (ff) { return (h("amplify-form-field", { label: ff.label, placeholder: ff.placeholder, required: ff.required, handleInputChange: ff.handleInputChange, value: ff.value, inputProps: ff.inputProps, disabled: ff.disabled })); },
};
...
var AmplifyCodeField = /** @class */ (function () {
    function AmplifyCodeField(hostRef) {
        ...
        this.label = I18n.get(Translations.CODE_LABEL);
        /** Used for the placeholder label */
        this.placeholder = I18n.get(Translations.CODE_PLACEHOLDER);
        /** The required flag in order to make an input required prior to submitting a form */
        this.required = false;
    }
    AmplifyCodeField.prototype.render = function () {
        return (h("amplify-form-field", { fieldId: this.fieldId, label: this.label, placeholder: this.placeholder, type: "number", hint: this.hint, required: this.required, handleInputChange: this.handleInputChange, value: this.value, inputProps: this.inputProps, disabled: this.disabled }));
    };
...
var AmplifyCountryDialCode = /** @class */ (function () {
    ...
    AmplifyCountryDialCode.prototype.render = function () {
        return h("amplify-select", { fieldId: this.fieldId, options: this.options, handleInputChange: this.handleInputChange });
    };
...
var AmplifyFormSection = /** @class */ (function () {
    ...
    AmplifyFormSection.prototype.render = function () {
        return (h("form", { onSubmit: this.handleSubmit }, h("amplify-section", null, h("div", null, h("slot", { name: "amplify-form-section-header" }, h("div", { class: "form-section-header" }, h("h3", { "data-test": this.testDataPrefix + '-header-section' }, this.headerText)))), h("slot", null), h("div", null, h("slot", { name: "amplify-form-section-footer" }, h("div", { class: "form-section-footer" }, h("amplify-button", { type: "submit", "data-test": this.testDataPrefix + '-' + this.testDataPrefix + '-button' }, h("amplify-loading-spinner", { style: { display: this.loading ? 'initial' : 'none' } }), h("span", { style: { display: this.loading ? 'none' : 'initial' } }, this.submitButtonText)), this.secondaryFooterContent))))));
    };
...
var AmplifyPasswordField = /** @class */ (function () {
    function AmplifyPasswordField(hostRef) {
        ...
        this.label = I18n.get(Translations.PASSWORD_LABEL);
        /** Used for the placeholder label */
        this.placeholder = I18n.get(Translations.PASSWORD_PLACEHOLDER);
        /** The required flag in order to make an input required prior to submitting a form */
        this.required = false;
    }
    AmplifyPasswordField.prototype.render = function () {
        return (h("amplify-form-field", { type: "password", fieldId: this.fieldId, label: this.label, placeholder: this.placeholder, hint: this.hint, required: this.required, handleInputChange: this.handleInputChange, value: this.value, inputProps: this.inputProps, disabled: this.disabled }));
    };
...
var AmplifyPhoneField = /** @class */ (function () {
    function AmplifyPhoneField(hostRef) {
        ...
        this.label = I18n.get(Translations.PHONE_LABEL);
        /** Used for the placeholder label */
        this.placeholder = I18n.get(Translations.PHONE_PLACEHOLDER);
        /** The required flag in order to make an input required prior to submitting a form */
        this.required = false;
    }
    AmplifyPhoneField.prototype.render = function () {
        return (h("div", null, h("amplify-form-field", { label: this.label, type: "tel", hint: this.hint, required: this.required }, h("div", { class: "phone-field", slot: "input" }, h("amplify-country-dial-code", { handleInputChange: this.handleInputChange }), h("amplify-input", { fieldId: this.fieldId, handleInputChange: this.handleInputChange, placeholder: this.placeholder, name: this.fieldId, value: this.value, inputProps: this.inputProps, disabled: this.disabled })))));
    };
...
var AmplifySelect = /** @class */ (function () {
    ...
    AmplifySelect.prototype.contructSelectOptions = function (opts) {
        var content = [];
        opts.forEach(function (opt) { return content.push(h("option", { value: opt.value }, opt.label)); });
        return content;
    };
...
var AmplifyUsernameField = /** @class */ (function () {
    function AmplifyUsernameField(hostRef) {
        ...
        this.label = I18n.get(Translations.USERNAME_LABEL);
        /** Used for the placeholder label */
        this.placeholder = I18n.get(Translations.USERNAME_PLACEHOLDER);
        /** The required flag in order to make an input required prior to submitting a form */
        this.required = false;
    }
    AmplifyUsernameField.prototype.render = function () {
        return (h("amplify-form-field", { fieldId: this.fieldId, label: this.label, placeholder: this.placeholder, required: this.required, handleInputChange: this.handleInputChange, value: this.value, inputProps: this.inputProps, disabled: this.disabled }));
    };
